...
public final class FragmentMainBinding implements ViewBinding {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mainContainerView;
      FragmentContainerView mainContainerView = ViewBindings.findChildViewById(rootView, id);
      if (mainContainerView == null) {
        break missingId;
      }

      return new FragmentMainBinding((ConstraintLayout) rootView, mainBottomNavigationView,
          mainContainerView);
    }
