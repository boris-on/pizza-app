 ...
 */
public abstract class Hilt_AsiaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AsiaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AsiaFragment_GeneratedInjector) this.generatedComponent()).injectAsiaFragment(UnsafeCasts.<AsiaFragment>unsafeCast(this));
    }
  }
