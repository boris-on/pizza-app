 ...
 */
public abstract class Hilt_CatalogFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CatalogFragment() {
    super();
  }

  Hilt_CatalogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CatalogFragment_GeneratedInjector) this.generatedComponent()).injectCatalogFragment(UnsafeCasts.<CatalogFragment>unsafeCast(this));
    }
  }
