 ...
 */
public abstract class Hilt_CardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardFragment_GeneratedInjector) this.generatedComponent()).injectCardFragment(UnsafeCasts.<CardFragment>unsafeCast(this));
    }
  }
